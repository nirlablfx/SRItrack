...
parser.add_argument('--cfg', type=str, default='../experiments/SRItrack/config.yaml',
...
def build_opt_lr(model, current_epoch=0):
    ...
    trainable_params += [{'params': model.bsdm1.parameters(),
                          'lr': cfg.TRAIN.BASE_LR}]
    trainable_params += [{'params': model.bsdm.parameters(),
                          'lr': cfg.TRAIN.BASE_LR}]

    trainable_params += [{'params': model.fpn.parameters(),
                          'lr': cfg.TRAIN.BASE_LR}]
    trainable_params += [{'params': model.spri.parameters(),
                          'lr': cfg.TRAIN.BASE_LR}]
