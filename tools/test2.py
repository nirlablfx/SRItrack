...
parser.add_argument('--dataset', type=str, default='UAV123_10fps',
        help='datasets')#OTB100 LaSOT UAV123 GOT10K
parser.add_argument('--vis', action='store_true',default=True,
        help='whether visualzie result')
parser.add_argument('--snapshot', type=str, default='./snapshot/checkpoint_e10.pth',
...
def main():
    ...
    for v_idx, video in enumerate(dataset):
        ...
        pred_bboxes = []
        track_times = []
        for idx, (img, gt_bbox) in enumerate(video):  #img  360,480,3   1080,1920,3
