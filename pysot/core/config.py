...
__C.MODEL.FPN.TYPE = "TREFPN"
__C.MODEL.HIDDEN_DIM = [256,256,256]
__C.MODEL.FPN.NBLOCKS = 2
__C.MODEL.FPN.PRE_CONV = [256,256,256]
__C.MODEL.FPN.NHEADS = 4
__C.MODEL.FPN.MLP_RATIOS = 4
__C.MODEL.FPN.QKV_BIAS = True
...
__C.DATASET.NAMES = ('VID','GOT','COCO','LaSOT')
...
__C.HP_SEARCH.UAV20L = [0.37, 0.19, 0.3]

__C.HP_SEARCH.LaSOT = [0.33, 0.04, 0.3]
__C.HP_SEARCH.VOT2016 = [0.35, 0.2, 0.45]
__C.HP_SEARCH.DTB70 = [0.5, 0.2, 0.35]
__C.HP_SEARCH.UAV123_10fps = [0.38, 0.18, 0.32]
